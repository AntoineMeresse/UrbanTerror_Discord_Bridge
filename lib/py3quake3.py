"""
Added support for python3 : Antoine Méresse
...
class PyQuake3(object):
    ...
    PyQuake3 class
    """
    packet_prefix = b'\377\377\377\377'
    ...
    def send_packet(self, data):
        ...
        send packet
        """
        self.sock.send(self.packet_prefix+data.encode())
    ...
    def parse_packet(self, data):
        ...
        if first_line_length == -1:
            raise Exception('Malformed packett')

        response_type = data[:first_line_length]
...
if __name__ == '__main__':
    ...
    QUAKE = PyQuake3(server='antoinemeresse.xyz:27960', rcon_password='Flifli')
